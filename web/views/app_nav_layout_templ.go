...
func AppNavLayout(content templ.Component, cfg linkwell.NavConfig, csrfToken string, devMode bool, theme string, crumbs []linkwell.Breadcrumb, links []linkwell.LinkRelation, currentPath string, version string, hubs []linkwell.HubEntry) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<body class=\"min-h-screen bg-base-200\" hx-history=\"false\" hx-boost=\"true\"><div class=\"app-shell\"><div id=\"app-lifeline\" hx-ext=\"sse\" sse-connect=\"/sse/app\" tavern-role=\"lifeline\" tavern-reconnecting-class=\"app-lifeline-disconnected\" style=\"display:none\"></div><!-- Sticky header group: banner + nav stick together --><div class=\"app-header sticky top-0 z-50 bg-base-100\"><div id=\"error-status\" aria-live=\"assertive\"></div><!-- Mobile topbar (CSS shows/hides) --><div class=\"app-topbar bg-base-100 border-b border-base-300 items-center justify-between px-4 py-2.5\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if cfg.Topbar != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/views/app_nav_layout.templ`, Line: 37, Col: 58}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "</footer><div id=\"report-modal-container\"></div><div id=\"report-email-container\"></div></div></body></html>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func appNavIcon(pathData string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.ResolveAttributeValue(pathData)
		if templ_7745c5c3_Err != nil {
