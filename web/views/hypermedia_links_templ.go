...
func linksEditorForm(routes []string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "<form hx-post=\"/api/links\" hx-target=\"#links-table\" hx-swap=\"outerHTML\" class=\"flex flex-wrap items-end gap-2\"><div class=\"form-control\"><label class=\"label py-0\" for=\"link-source\"><span class=\"label-text text-xs\">Source</span></label> <input id=\"link-source\" name=\"source\" list=\"link-routes\" placeholder=\"/apps/inventory\" required class=\"input input-bordered input-sm w-44\"></div><div class=\"form-control\"><label class=\"label py-0\" for=\"link-rel\"><span class=\"label-text text-xs\">Rel</span></label> <select id=\"link-rel\" name=\"rel\" class=\"select select-bordered select-sm w-32\"><option value=\"related\">related</option> <option value=\"up\">up</option> <option value=\"create-form\">create-form</option></select></div><div class=\"form-control\"><label class=\"label py-0\" for=\"link-target\"><span class=\"label-text text-xs\">Target</span></label> <input id=\"link-target\" name=\"target\" list=\"link-routes\" placeholder=\"/apps/catalog\" required class=\"input input-bordered input-sm w-44\"></div><div class=\"form-control\"><label class=\"label py-0\" for=\"link-title\"><span class=\"label-text text-xs\">Title</span></label> <input id=\"link-title\" name=\"title\" placeholder=\"Catalog\" required class=\"input input-bordered input-sm w-32\"></div><div class=\"form-control\"><label class=\"label py-0\" for=\"link-group\"><span class=\"label-text text-xs\">Group</span></label> <input id=\"link-group\" name=\"group\" placeholder=\"(optional)\" class=\"input input-bordered input-sm w-28\"></div><button type=\"submit\" class=\"btn btn-primary btn-sm\">Add</button> <datalist id=\"link-routes\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for _, route := range routes {
			...
			templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.ResolveAttributeValue(route)
			if templ_7745c5c3_Err != nil {
		...
		for _, src := range sortedLinkPaths(data.Links) {
			for i, link := range data.Links[src] {
				...
				if i == 0 {
					...
					templ_7745c5c3_Var19, templ_7745c5c3_Err = templ.ResolveAttributeValue(linksRowspan(data.Links[src]))
					if templ_7745c5c3_Err != nil {
				...
				if id := storedLinkID(data.StoredLinks, src, link.Rel, link.Href); id > 0 {
					...
					templ_7745c5c3_Var25, templ_7745c5c3_Err = templ.ResolveAttributeValue(linkDeleteURL(id))
					if templ_7745c5c3_Err != nil {
